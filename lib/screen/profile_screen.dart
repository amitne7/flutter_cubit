...
import 'package:personal_security_officer/cubits/logout_cubit.dart';

import '../widget/dialog/layouts/logout_account_dialog.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
                      ...
                      return CustomInkWellContainer(
                        onTap: () {
                          ...
                          if (token == "") {
                            ...
                            final UserModel userDetails = context
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildListItemWidget(
                        ...
                        title: 'becomeGuard'.translate(context: context),
                        bottomPadding: 16,
                        onTap: () => _handleBecomeGuardClick(context),
                      ),
                      // _buildListItemWidget(
  ...
  Future<void> _handleBecomeGuardClick(BuildContext context) async {
        ...
        child: CustomInkWellContainer(
          ...
          child: Row(
            children: [
              CustomSvgPicture(
                svgImage: imageName,
                color: imageColor ?? context.colorScheme.blackColor,
                height: 24,
                width: 24,
              ),
              const SizedBox(
