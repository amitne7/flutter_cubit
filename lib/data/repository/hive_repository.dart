...
class HiveRepository {
  ...
  static String loginTokenKey = "login_token";
  ...
  static String? get getLoginToken => Hive.box(userDetailBoxKey).get(loginTokenKey);

  static set setLoginToken(username) =>
      Hive.box(userDetailBoxKey).put(loginTokenKey, username);
