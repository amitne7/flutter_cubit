...
import 'package:personal_security_officer/cubits/geo_location_cubit.dart';
import 'package:personal_security_officer/cubits/home_screen_cubit.dart';
import 'package:personal_security_officer/firebase_options.dart';
...
Future<void> initApp() async {
  ...
  //FirebaseMessaging.onBackgroundMessage(NotificationService.onBackgroundMessageHandler);
   /*************************************
  Commnented by amit for leaving that time 
  **************************************
  try {
