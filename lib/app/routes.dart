...
// import 'package:personal_security_officer/screen/notification_screen.dart';
...
class Routes {
  ...
  static Route<dynamic> onGeneratedRoute(final RouteSettings routeSettings) {
    ...
    switch (routeSettings.name) {
      ...
      case loginRoute:
        return LoginCustomerScreen.route(routeSettings);
      ...
      case notAvailable:
        return CupertinoPageRoute(builder: (final _) => const NotAvailableScreen());
